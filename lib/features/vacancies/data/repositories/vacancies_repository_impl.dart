  ...
  List<Vacancy> _getDronesVacancies() {
    return [
      Vacancy(
        ...
        experience: '1-3 роки',
        requirements: const ['Досвід роботи з дронами', 'Військова освіта'],
        benefits: const ['Страхування', 'Відпустка'],
        categoryId: 'drones',
  ...
  List<Vacancy> _getPersonalVacancies() {
    return [
      Vacancy(
        ...
        requirements: const ['Відповідний досвід'],
        benefits: const ['Повний соцпакет'],
        categoryId: 'for_you',
        createdAt: DateTime.now(),
        iconPath: 'images/drone_icon.png',
        ),
